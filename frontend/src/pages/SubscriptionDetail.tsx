            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                {subscription.description && (
                  <p className="text-gray-600 mt-2">{subscription.description}</p>
                )}
              </div>
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{subscription.billingCycle}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{subscription.category}</p>
                </div>
              </div>
            </div>
            ...
            {subscription.notes && (
              <div>
                ...
                <p className="text-gray-600 bg-gray-50 p-3 rounded-lg">{subscription.notes}</p>
              </div>
            )}
